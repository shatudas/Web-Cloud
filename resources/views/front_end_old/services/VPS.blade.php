...
@section('home_page')
   ...
   <div class="container">
    <div class="row">
     ...
     <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200" >
      <h1 class="pt-5">{{ $VPS->title }}</h1>
     </div>
     <div class="col-lg-6 order-1 order-lg-2 host-img d-none d-md-inline-block text-black" data-aos="zoom-in" data-aos-delay="200" align="center">
      <img src="{{ !empty($VPS->image)?url('upload/Cover_image/'.$VPS->image):url('frontend/image/cover_image/VPS.png') }}" class="img-fluid animated" alt="">
     </div>
   ...
   <section  class="section-bg" style="padding-top:0px;" style="background-color:#FFFFF8;">
    <div class="container pt-0" data-aos="fade-up" >
     ...
     <div class="section-title py-5" >
      <h1 class="serviceshrad"> Best VPS Server in Bangladesh. </h1>
      <h4> Deploy your own cloud VPS server Easily. Dedicated VPS Hosting </h4>
     </div>

     <div class="row">

      @foreach($PackageManage as $VPS)  
       ...
       <div class="icon-box w-100 p-0 m-0">
        ...
        <div class=" host-package-head">
          <div class="w-100 py-2 name-body">
           <h3 class="text-justify package-name"><center><b> {{ $VPS->name }} </b></center></h3>
         </div>
         <div class="w-100 title_body">
          <h4 class="text-justify package-price">
            <center>
              <strong> ৳ </strong>
              <span> {{ $VPS->price }} </span>
              <small> / {{ $VPS->duration }} * </small>
            </center>
          </h4>
          <div class="mt-4 host-package-btn" align="center">
           <a href="{{ $VPS->url }}" class="btn btn-primary" title="Get Started">Get Started</a>
          </div>
        </div>
        </div>
        ...
        <div class="mt-3 host-package-body" align="left">
         ...
         <ul class="icon-list-items p-2" style="list-style:none;">
          ...
          @php
          $feature = json_decode($VPS->fetures);
          @endphp
  ...
  <section id="SMS_benefits" style="padding-top:0px;">
   <div class="container">
    ...
    <div class="section-title mb-0 py-5">
     <h1  class="domain_head"> Why Choose InCom Cloud VPS Features   </h1>
    </div>
    
    <div class="row">
    
     @foreach($PackageFeture as $feture)
     <div class="col-xl-3 SMS_benefits col-md-6 col-sm-12 d-flex align-items-stretch p-2" data-aos="zoom-out" data-aos-delay="100">
  ...
  <section id="web_benefits" style="padding-top:0px;">
   <div class="section-title mb-0 py-5" data-aos="zoom-out" data-aos-delay="100">
    <h1  class="domain_head"> Essential  Service </h1>
   </div>
   <div class="container">
    <div class="row">
