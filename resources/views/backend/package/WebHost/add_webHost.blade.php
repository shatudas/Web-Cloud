      ...
      <div class="row justify-content-center">
       <div class="col-10">
        <div class="card">
         ...
         <div class="card-body">
          <form method="POST" action="{{ route('web_hosting.store') }}" enctype="multipart/form-data" id="myForm">
          @csrf
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="number" name="storage" class="form-control" placeholder="Enter Storage " min="0">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="number" name="bandwidth" class="form-control" placeholder="Enter Bandwidth" min="0">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="number" name="addom_domain" class="form-control" placeholder="Enter Sub Domain" min="0">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="number" name="subdomain" class="form-control" placeholder="Enter Sub Domain" min="0">
             <font style="color:red">{{ ($errors->has('subdomain'))?($errors->first('subdomain')):'' }}</font>
            </div>

            <div class="form-group col-md-6">
             <label for="mail"> Mail <span style="color:red;">*</span> </label>
             <input type="number" name="mail" class="form-control" placeholder="Enter Mail Account" min="0">
             <font style="color:red">{{ ($errors->has('mail'))?($errors->first('mail')):'' }}</font>
            </div>

            <div class="form-group col-md-6">
             <label for="sql">SQL <span style="color:red;">*</span> </label>
             <input type="number" name="sql" class="form-control" placeholder="Enter SQL" min="0"> 
            ...
            <div class="form-group col-md-6">
             ...
             <input type="number" name="data_taffic" class="form-control" placeholder="Data Taffic..." min="0"> 
            ...
            <div class="form-group col-md-6">
             ...
             <input type="text" name="os" class="form-control" placeholder="Oparating System...">
             <font style="color:red">{{ ($errors->has('os'))?($errors->first('os')):'' }}</font>
            </div>

            <div class="form-group col-md-6">
             <label for="backup">backup System <span style="color:red;">*</span> </label>
             <input type="text" name="backup" class="form-control" placeholder="Backup System...">
             <font style="color:red">{{ ($errors->has('backup'))?($errors->first('backup')):'' }}</font>
            </div>

            <div class="form-group col-md-6">
             <label for="price"> Price <span style="color:red;">*</span> </label>
             <input type="number" name="price" class="form-control" placeholder="Enter package Price" min="0">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="text" name="url" class="form-control" placeholder="Enter Package URL">
