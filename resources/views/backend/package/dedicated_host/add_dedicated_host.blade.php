 ...
 <div class="content-wrapper">
  ...
  <div class="content-header">
   <div class="container-fluid">
    <div class="row mb-2">
     <div class="col-sm-6">
      <h1 class="m-0"> VPS Dedicated Hosting </h1>
     </div><!-- /.col -->
     <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
       <li class="breadcrumb-item"><a href="{{ route('home') }}"> Home </a></li>
       <li class="breadcrumb-item active"> VPS Dedicated Hosting </li>
      </ol>
     </div>
    </div>
   </div>
       ...
       <div class="col-10">
        <div class="card">
         ...
         <div class="card-header">
          <h3> Add VPS Dedicated Hosting
           <a href="{{ route('dedicated_hosting.view') }}" class=" btn btn-primary btn-sm float-right"><i class="fa fa-list"></i> Service Type List </a>
          </h3>
         </div>

         <div class="card-body">
          <form method="POST" action="{{ route('dedicated_hosting.store') }}" enctype="multipart/form-data" id="myForm">
          @csrf
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="text" name="cpu" class="form-control" placeholder="Enter CPU Range">
             <font style="color:red">{{ ($errors->has('cpu'))?($errors->first('cpu')):'' }}</font>
            </div>

            <div class="form-group col-md-6">
             <label for="core"> Core <span style="color:red;">*</span> </label>
             <input type="text" name="core" class="form-control" placeholder="Enter RAM Range">
             <font style="color:red">{{ ($errors->has('core'))?($errors->first('core')):'' }}</font>
            </div>
            ...
            <div class="form-group col-md-6">
             ...
             <input type="text" name="ram" class="form-control" placeholder="Enter RAM Range">
             <font style="color:red">{{ ($errors->has('ram'))?($errors->first('ram')):'' }}</font>
            </div>

            <div class="form-group col-md-6">
             <label for="bandwidth"> Bandwidth <span style="color:red;">*</span> </label>
             <input type="text" name="bandwidth" class="form-control" placeholder="Enter Bandwidth">
