       ...
       <div class="col-10">
        <div class="card">
         ...
         <div class="card-header">
          <h3> Edit VPS Dedicated Hosting
           <a href="{{ route('dedicated_hosting.view') }}" class=" btn btn-primary btn-sm float-right"><i class="fa fa-list"></i> Service Type List </a>
          </h3>
         </div>

         <div class="card-body">
          <form method="POST" action="{{ route('dedicated_hosting.update',$editdata->id) }}" enctype="multipart/form-data" id="myForm">
          @csrf
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="text" name="core" class="form-control" value="{{ $editdata->core }}" placeholder="Enter RAM Range">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="number" name="price" class="form-control" value="{{ $editdata->price }}" placeholder="Enter package Price">
