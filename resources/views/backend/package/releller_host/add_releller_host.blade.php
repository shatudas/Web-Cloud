          ...
          @csrf
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="number" name="cpanel" class="form-control" placeholder="Enter Number of Cpanel ">
            ...
            <div class="form-group col-md-6">
             ...
             <input type="number" name="ip" class="form-control" placeholder="Enter Dedicated IP">
