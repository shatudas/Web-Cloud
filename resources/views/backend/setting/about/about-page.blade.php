          ...
          @csrf
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-8" align="justify-content-center">
             <img id="showImage" src="{{ !empty($editData->image)?url('upload/about_image/'.$editData->image):url('upload/No-image.jpg') }}" style="width:300px; height:150px; margin-top:30px; border:1px solid #ccc;" align="right">
            </div>
